...
const productData = {
  ...
  category: "Gấu Bông",
  description:
    "Gấu bông Teddy Brown - người bạn đồng hành hoàn hảo với chất liệu vải nhung siêu mềm mịn, ôm ấp thoải mái mà không lo xẹp lún. Món quà ý nghĩa cho mọi dịp đặc biệt và người bạn tuyệt vời cho mọi lứa tuổi!",
  fullDescription: `
    <div class="enhanced-description">
      <h3>Gấu Bông Teddy Brown - Người bạn đồng hành hoàn hảo</h3>

      <div class="highlight-box">
        <p class="font-medium">Gấu bông Teddy Brown được làm từ chất liệu vải nhung cao cấp, siêu mềm mịn với độ đàn hồi tốt giúp bạn có thể ôm ấp thoải mái mà không lo bị xẹp lún. Bề mặt vải mềm mịn cùng độ dày lý tưởng giúp giữ ấm trong những ngày đông lạnh giá.</p>
      </div>

      <p>Được nhồi bằng bông gòn cao cấp, gấu Teddy Brown có độ đàn hồi tốt, không bị vón cục hay xẹp lún sau thời gian dài sử dụng. Các đường may tỉ mỉ, chắc chắn đảm bảo độ bền và an toàn cho người sử dụng.</p>
      ...
      <div class="feature-grid">
        <div class="feature-card">
          ...
          <p class="font-medium">Chất liệu cao cấp</p>
        </div>
        <div class="feature-card">
      ...
      <ul>
        <li>Chất liệu vải nhung cao cấp, mềm mịn như nhung tơ tằm</li>
        <li>Bông nhồi cao cấp, không gây dị ứng, không vón cục</li>
        <li>Đường may tỉ mỉ, chắc chắn từng chi tiết</li>
        <li>Thiết kế đáng yêu với đôi mắt to tròn, biểu cảm dễ thương</li>
        <li>Màu sắc tự nhiên, không phai màu sau nhiều lần giặt</li>
      ...
      <div class="highlight-box">
        <p class="font-medium">Gấu bông Teddy Brown là món quà ý nghĩa cho người thân, bạn bè trong các dịp sinh nhật, lễ tình nhân, kỷ niệm... Với thiết kế đáng yêu và chất lượng vượt trội, Teddy Brown chắc chắn sẽ là người bạn đồng hành tuyệt vời của bạn.</p>
      </div>
    </div>
  `,
  specifications: `
    <table class="min-w-full border border-gray-300">
      ...
      <tbody>
        <tr>
          ...
          <td class="py-2 px-4 border-b border-gray-300">Gấu Bông Teddy Brown</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="py-2 px-4 border-b border-gray-300">Nâu, Hồng, Trắng, Xám</td>
        </tr>
        <tr>
  ...
  reviews: [
    {
      ...
      date: "15/04/2025",
      comment:
        "Chất lượng gấu bông rất tốt, mềm mại và êm ái. Đường may chắc chắn, màu sắc đẹp đúng như hình. Đóng gói cẩn thận, giao hàng nhanh. Sẽ ủng hộ shop dài dài.",
      images: [
    ...
    },
    {
      ...
      date: "10/04/2025",
      comment:
        "Gấu bông xinh xắn, đáng yêu. Chất lượng tốt, đúng kích thước như mô tả. Tuy nhiên bông hơi cứng một chút so với mong đợi. Nhưng nhìn chung là rất ok.",
      images: [],
    },
    {
      id: 3,
      ...
      date: "05/04/2025",
      comment:
        "Mua tặng sinh nhật cho bạn gái và cô ấy rất thích. Gấu bông mềm mại, dễ thương và không có mùi hôi. Shop tư vấn nhiệt tình, đóng gói cẩn thận. Sẽ quay lại ủng hộ!",
    ...
    },
    {
      ...
      date: "01/04/2025",
      comment:
        "Sản phẩm tạm được, chất liệu khá tốt nhưng kích thước nhỏ hơn một chút so với mô tả. Đường may ở một số chỗ chưa được tỉ mỉ lắm. Giao hàng nhanh.",
      images: [],
    },
    {
      id: 5,
      user: "Hoàng Thị Lan Anh",
      avatar: "assets/images/avatars/user5.jpg",
      rating: 5,
      date: "28/03/2025",
      comment:
        "Siêu đáng yêu luôn ạ! Chất liệu mềm mại, màu sắc tươi sáng, đường may tỉ mỉ. Mình mua size L và thấy rất đáng tiền. Sẽ giới thiệu cho bạn bè.",
      images: [
  ...
  sizes: [
    ...
    { size: "M", price: 650000 },
    { size: "L", price: 850000 },
    { size: "XL", price: 1050000 },
    { size: "XXL", price: 1250000 },
  ],
  images: [
    "../assets/img/products/gaubong (1).jpg",
    "../assets/img/products/gaubong (2).jpg",
    "../assets/img/products/gaubong (3).jpg",
    "../assets/img/products/gaubong (4).jpg",
  ],
  relatedProducts: [
    {
      id: "rp001",
      ...
      discount: 15,
      image: "../assets/img/products/panda.jpg",
      rating: 4.8,
    },
    {
      id: "rp002",
...
function displayProductData(product) {
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="w-2/3">
        <div class="flex items-center mb-2">
          ...
          <span class="w-16 text-sm text-gray-600 text-right">75%</span>
        </div>
        <div class="flex items-center mb-2">
          ...
          <span class="w-16 text-sm text-gray-600 text-right">20%</span>
        </div>
        <div class="flex items-center mb-2">
  ...
  product.relatedProducts.forEach((relatedProduct) => {
    ...
    productSlide.innerHTML = `
      <a href="product-details-2.html" class="block">
